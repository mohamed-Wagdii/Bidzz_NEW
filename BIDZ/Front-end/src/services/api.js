 ...
 * Handles login, registration, OAuth, and profile management.
 */
...
export const authAPI = {
  ...
  getDashboard: () => api.get("/analysis/dashboard").then((r) => r.data),
};

/**
 * Auctions API endpoints
 * Handles CRUD operations, querying, and ending of auctions.
 */
...
/**
 * Bids API endpoints
 * Handles placing bids and fetching bid history.
 */
 ...
 * Handles product creation (with multipart/form-data for images) and retrieval.
 */
 ...
 * Handles purchasing and fetching user tickets.
 */
 ...
 * Handles order creation, payments, status updates, and shipping details.
 */
...
/**
 * Chat API endpoints
 * Handles conversation management, real-time messaging, and typing indicators.
 */
 ...
 * Handles queries sent to the RAG AI service.
 */
export const aiAPI = {
 ...
 * Handles standalone image uploads.
 */
 ...
 * Handles fetching platform-wide metrics for admins.
 */
export const analyticsAPI = {
  get: () => api.get("/analysis/").then((r) => r.data),
};

/**
 * Reports API endpoints
 * Handles submission, retrieval, and resolution of user reports.
 */
 ...
 * Handles user wallet balance, deposits, withdrawals, and transaction history.
 */
...
/**
 * Admin API endpoints
 * Specialized endpoints for platform administration (users, auctions, orders, finances).
 */
